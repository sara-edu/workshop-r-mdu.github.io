...
# [DOING RESEARCH<br>USING R]{.r-fit-text .navy-blue data-hide-slide-number="true"} {background-image="https://images.unsplash.com/photo-1508161250369-a7ecbdfb67fe?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" background-size=cover background-position="100% 0%"}
...
```{=html}
<a class="github-button" href="https://github.com/sara-edu/workshop-r-mdu.github.io" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star this course on Github">Star this slide on Github</a><script async defer src="https://buttons.github.io/buttons.js"></script>
```
:::
...
::: {.column width="50%"}
![SARA Institute of Data Science Sonipat](images/sara.png){width=50%}
:::
...
[This is what we [think]{.theme-red} we do ...]{.r-fit-text}

## Research {.center}

[But this is what we [actually]{.theme-red} do]{.r-fit-text}
...
[🎃 09 AM to 11 am - Introduction to R & RStudio]{.r-fit-text}

[🎃 02 pm to 04 pm - Reproducible Documents using Quarto]{.r-fit-text}

### DAY 2

#### Set Yourself Apart:

[🎃 09 AM to 11 AM - Introduction to GitHub]{.r-fit-text}

[🎃 02 PM to 04 PM - Website using Quarto]{.r-fit-text}
...
## RStudio projects helps: {background-image="images/r-projects.jpg" background-size="55%" background-position="bottom right"}
...
## [In case anything go wrong$...$]{.theme-red} {.center}
...
## [Post community](https://community.rstudio.com/latest) {.center}
...
![](images/help-tweet.png){fig-align="center"}
